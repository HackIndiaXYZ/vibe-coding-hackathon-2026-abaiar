...
import { TTS_PROVIDERS, DEFAULT_TTS_VOICES, getTTSProvider } from '@/lib/audio/constants';
...
export function TTSSettings({ selectedProviderId }: TTSSettingsProps) {
  ...
  const effectiveVoice =
    selectedProviderId === activeProviderId
      ? ttsVoice
      : (DEFAULT_TTS_VOICES as Record<string, string>)[selectedProviderId] || 'default';

  const ttsProvider = getTTSProvider(selectedProviderId) ?? TTS_PROVIDERS['openai-tts'];
